...
const Footer = () => {
  return (
    <footer className="w-full py-12 md:py-16 px-6 md:px-12 border-t border-border/30 bg-background/50">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center justify-center space-y-6">
          <Logo />
          <p className="text-muted-foreground/80 max-w-md text-center text-base leading-relaxed">
          ...
          <div className="flex items-center gap-5">
            <a href="#" className="h-11 w-11 rounded-full bg-muted/50 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-all">
        ...
        <div className="mt-8 pt-6 border-t border-border/30 flex flex-col md:flex-row justify-between items-center text-muted-foreground/70 text-sm">
